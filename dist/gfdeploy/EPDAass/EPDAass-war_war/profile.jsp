<%-- 
    Document   : profile
    Created on : 23 May 2024, 5:16:41 pm
    Author     : vandycklai
--%>
...
<%
    ...
    if (role.equals("customer")) {
        ...
        editingUser = (Trainer) session.getAttribute("user");
    } else if (role.equals("staff")) {
        editingUser = (Staff) session.getAttribute("user");
    } else {
    editingUser = (SuperAdmin) session.getAttribute("user");
    }
 %>
<!DOCTYPE html>
<html>
  ...
  <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
       ...
       <div class="m-6 sm:ml-64">
                            <h1 class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-6xl dark:text-white">Edit Profile</h1>
...
<label for="gender" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gender</label>
                            ...
                            <button type="submit" value="profile" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</button>
                            <%
                                if (session.getAttribute("updateProfileError") != null) {
                            %>
                            <div id="alert-additional-content-2" class="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                                ...
                                <div class="mt-2 mb-4 text-sm">
                                    <%=session.getAttribute("updateProfileError")%>
                                </div>
                                <div class="flex">
