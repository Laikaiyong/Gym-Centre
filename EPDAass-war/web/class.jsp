<%-- 
    Document   : class
    Created on : 23 May 2024, 5:16:58 pm
    Author     : vandycklai
--%>
...
<%
    List<GymClass> gymClasses = (List<GymClass>) request.getAttribute("classes");
%>
...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <h1 class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-6xl dark:text-white">Gym Class</h1>
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <%
                                if (session.getAttribute("userRole").toString().equals("trainer")) {
                            %><a href="addGymClass" type="button" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
    ...
    <% for (GymClass gym : gymClasses) { %>
      <tr class="border-b dark:border-gray-700">
                            ...
                            %><a href="updateGymClass?id=<%= gym.getId() %>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Update</a><%}%>
                                <%
                                if (session.getAttribute("userRole").toString().equals("trainer")) {
                            %><a href="viewGymDetails?id=<%= gym.getId() %>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">View</a><%}%>
                                <%
                                if (session.getAttribute("userRole").toString().equals("customer")) {
                            %><a href="enrolGymClass?id=<%= gym.getId() %>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Select</a><%}%>
                            </td>
                        </tr>
    <% } %>
     ...
     <%
         Customer editingUser = new Customer();
                                if (session.getAttribute("userRole").toString().equals("customer")) {
                                editingUser = (Customer) session.getAttribute("user");
         }
         if (session.getAttribute("userRole").toString().equals("customer")) {
                            %><section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
   
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <h1 class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-6xl dark:text-white">Enrolled Class</h1>
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
    <% for (GymClass gym : editingUser.getClasses()) { %>
      <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"> <%= gym.getId() %></th>
                            <td class="px-4 py-3"> <%= gym.getName() %></td>
                            <td class="px-4 py-3"> <%= gym.getPaymentStatus() %></td>
 ...
 <%
                                             ...
                                             if (session.getAttribute("addClass") != null && session.getAttribute("userRole").toString().equals("trainer")) {
                            %>
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                            Add a Gym Class
                        </h1>
                        <form class="space-y-4 md:space-y-6" action="addGymClass" method="POST" >
                            ...
                            <div>
                                ...
                                <input type="number" name="fee" id="fee" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Fee" min="1" required="">
                            </div>
   


                            <button type="submit" value="addGymClass" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                            <%
                            ...
                            <div id="alert-additional-content-2" class="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                                ...
                                <div class="mt-2 mb-4 text-sm">
                                    <%=session.getAttribute("addClassError")%>
                                </div>
                                <div class="flex">
                            ...
                            <%}%>
                                ...
                                <%
                                             if (session.getAttribute("updateClass") != null && session.getAttribute("userRole").toString().equals("staff")) {
                            %>
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                            Update class
                            ...
                            GymClass gym = (GymClass) session.getAttribute("updateClass");
                                %>
                        <form class="space-y-4 md:space-y-6" action="updateGymClass" method="POST" >
                            <p>Class: <%= gym.getId() + ": " + gym.getName() %></p>
                                                                    
                            <div>
                                <label for="payment" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Payment Status</label>
                                <input type="number" name="payment" id="payment" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Payment" min="0" max="1" required="">
                            </div>  
                            
                            <div>
<label for="customer" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Customer</label>
                                    <%
                                    for (Customer cust: (List<Customer>) request.getAttribute("customers")) {
                                    %>
                                                                    <div class="my-2 flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                                                                        <input checked=<%= cust.getUsername().equals("customer1") %> id=<%= "bordered-radio-" + cust.getId().toString() %> type="radio" value=<%= cust.getId() %> name="customer" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="bordered-radio-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"><%= cust.getUsername() %></label>
                                </div>
                                                                    <%}%>
                                ...
                                <button type="submit" value="updateGymClass" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                            <%
                                if (session.getAttribute("updateGymClassError") != null) {
                            %>
                            <div id="alert-additional-content-2" class="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                                <div class="flex items-center">
                                    <svg class="flex-shrink-0 w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="mt-2 mb-4 text-sm">
                                    <%=session.getAttribute("updateGymClassError")%>
                                </div>
                                <div class="flex">
                                    <button type="button" class="text-red-800 bg-transparent border border-red-800 hover:bg-red-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center dark:hover:bg-red-600 dark:border-red-600 dark:text-red-500 dark:hover:text-white dark:focus:ring-red-800" data-dismiss-target="#alert-additional-content-2" aria-label="Close">
                                        Dismiss
